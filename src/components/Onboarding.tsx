...
const SLIDES=[{"accent": "#f59e0b", "icon": "\ud83d\udccf", "title": "Convert any unit\ninstantly", "desc": "Length, weight, temperature, volume, speed, and 90+ more categories."}, {"accent": "#d97706", "icon": "\u26a1", "title": "Real-time\nconversion", "desc": "Type a number and see all units update instantly."}, {"accent": "#b45309", "icon": "\ud83d\udcf1", "title": "Works completely\noffline", "desc": "All conversion formulas stored locally. No internet required."}];
  ...
  return (
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',background:'#08080f',position:'relative'}}>
      ...
      <div style={{padding:'20px 24px',display:'flex',justifyContent:'flex-end'}}>
        <button onClick={onDone} style={{color:'#f59e0b50',fontSize:'14px',background:'none',border:'none',cursor:'pointer',fontFamily:'Inter'}}>Skip</button>
      </div>
      <div key={idx} style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'20px 32px',textAlign:'center',animation:'sIn .35s ease'}}>
        ...
        <p style={{color:'#f59e0b70',fontSize:'14px',lineHeight:'1.7',maxWidth:'270px'}}>{slide.desc}</p>
      </div>
